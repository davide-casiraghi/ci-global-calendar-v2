...
@section('content')
    ...
    <form class="space-y-6" method="POST" action="{{ route('organizers.update',$organizer) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6">
                        @include('partials.forms.select_multiple', [
                            ...
                            'selected' => old('country_ids', $organizer->countries->modelKeys()),
                            'required' => false,
                    ...
                    <div class="col-span-6">
                        @include('partials.forms.input', [
                                ...
                                'name' => 'facebook',
                                'placeholder' => '',
                                'value' => old('facebook', $organizer->facebook),
                                'required' => false,
                                'disabled' => false,
                        ])
                    </div>
