<div class="relative bg-white z-40" x-data="Components.popover({ open: false, focus: false })" x-init="init()" @keydown.escape="onEscape" @close-popover-group.window="onClosePopoverGroup">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 bg-calendarGold">
        <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1 items-center">
                <a href="{{route('home')}}" class="-m-3 p-3 flex items-start hover:bg-calendarGoldHover">
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                ...
                <a href="{{route('register')}}" class="-m-3 p-3 flex items-start hover:bg-calendarGoldHover ml-3">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="h-5 w-5 text-white">
                ...
                <a href="{{route('login')}}" class="-m-3 p-3 flex items-start hover:bg-calendarGoldHover ml-3">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sign-in" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-5 w-5 text-white">
