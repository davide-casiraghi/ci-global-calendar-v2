...
@include('partials.navigation.items.secondLevelBasic', [
    ...
    'route' => route('users.edit', Auth::user()),
    'svg' => '<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="user-cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="flex-shrink-0 h-6 w-6 text-primary-600">
...
<a href="{{ route('logout') }}"
   ...
   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sign-out-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="flex-shrink-0 h-6 w-6 text-primary-600">
