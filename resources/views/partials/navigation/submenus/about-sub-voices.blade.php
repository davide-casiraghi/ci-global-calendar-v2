...
@include('partials.navigation.items.secondLevelBasic', [
        ...
        'svg' => '<svg class="flex-shrink-0 h-6 w-6 text-indigo-600" x-description="Heroicon name: outline/cursor-click" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 640 512" stroke="currentColor" aria-hidden="true">
