...
<button type="submit" class="inline-flex items-center border font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 {{$kindClasses}} {{$sizeClasses}} {{$extraClasses}}">
    {{$title}}
</button>