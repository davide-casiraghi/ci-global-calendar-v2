<li>
    <a href="{{route('eventCategories.edit', $eventCategory->id)}}" class="block hover:bg-gray-50">
        <div class="px-4 py-4 sm:px-6">
            ...
            <div class="mt-2 sm:flex sm:justify-between">
                ...
                <div class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                    ...
                    <p>
                        Created on
                        <time datetime="{{$eventCategory->created_at->format('Y-m-d')}}">
                            {{$eventCategory->created_at->format('M j, Y')}}
                        </time>
                    </p>
                </div>
            </div>
