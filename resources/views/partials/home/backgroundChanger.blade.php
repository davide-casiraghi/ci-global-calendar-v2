...
<div class="backgroundChanger bg-gray-600 w-full h-full fixed z-0 bg-no-repeat bg-cover bg-fixed absolute top-0 left-0 transition ease-in-out"
    style="background-image:url({{$firstBackgroundUrl}});"
></div>
