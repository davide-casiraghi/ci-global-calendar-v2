            ...
            <div class="col-span-2 md:col-span-1 flex flex-col md:flex-row">
                @if(!empty($event->website_event_link))
                    <div class="flex">
                        ...
                        <a class="textLink" target="_blank" href="{{$event->website_event_link}}">@lang('general.website')</a>
                    </div>
                @endif
            </div>
            ...
            <div class="col-span-2 md:col-span-1 flex flex-col md:flex-row mt-2 md:mt-0">
                @if(!empty($event->facebook_event_link))
                    <div class="flex">
                        ...
                        <a class="textLink" target="_blank" href="{{$event->facebook_event_link}}">@lang('event.facebook_event')</a>
                    </div>
                @endif
            </div>
        </div>
