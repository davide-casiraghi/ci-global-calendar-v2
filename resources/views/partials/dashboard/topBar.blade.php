            ...
            @if(Auth::user()->isAdmin())
                ...
                <div x-data="{ openSettings: false }" class="relative">
                    ...
                    >
                        ...
                        <a href="{{route('backgroundImages.index')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex" role="menuitem">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="ml-3 relative" x-data="{ open: false }">
                <div>
                    <button class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu" aria-haspopup="true">
                        ...
                        @php($avatarFileName = Auth::id()."_avatar.png")
                        @if(file_exists('images/avatars/'.$avatarFileName))
                            <img @click="open = true" class="inline h-8 w-8" src="{{asset('images/avatars/'.$avatarFileName)}}" alt="user avatar">
                        @else
                            <svg @click="open = true" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-8 w-8 text-gray-400">
